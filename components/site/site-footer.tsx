    ...
    <footer className="border-t border-[#2e2e2b] bg-[#1d1d1b] text-[#f5f5f3]">
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-[1.5fr_0.7fr_0.9fr] sm:gap-8">
          <div>
            <Link href="/" className="text-xl font-semibold tracking-[-0.06em]">HnJ<span className="text-[#8f8f8a]">.</span></Link>
        ...
        <div className="mt-10 flex flex-col gap-5 rounded-2xl bg-[#2a2a27] p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
          <div><p className="text-xs uppercase tracking-[0.16em] text-[#858580]">Need a hand?</p><h2 className="mt-2 text-xl font-medium tracking-[-0.04em]">Talk to HnJ Admin.</h2></div>
